...
- (void)viewDidLoad {
    ...
    [self.fontPicker setFrame:CGRectMake(self.pickerView.frame.origin.x, self.pickerView.frame.origin.y, self.pickerView.frame.size.width*0.95, self.pickerView.frame.size.height*0.65)];
